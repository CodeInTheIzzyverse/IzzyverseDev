            ...
            <div className="projectSelectorCard__body">
                ...
                <div className="projectSelectorCard__buttons">
                    {liveLinks.map((link, index) => (
                        <Button key={`live-${project.slug}-${index}`}>
                            <Link to={link} target="_blank" rel="noopener noreferrer">Live demo</Link>
                        </Button>
                    ))}

                    {githubLinks.map((link, index) => (
                        <Button key={`github-${project.slug}-${index}`} variant="secondary">
