    ...
    return (
        <div className="projectCard">
            <div className="projectCard__header">
                ...
                <div className="projectCard__weapons">
                    {
                        weapons.map((weapon) => (
            ...
            <div className="projectCard__body">
                ...
                <div className="projectCard__body-buttons">
                    {liveLinks.map((link, index) => (
                        <a href={link} target="_blank">
                            <Button key={`live-${project.slug}-${index}`} variant="secondary">
                                Live demo
                            </Button>
                        </a>
                    ))}
                    ...
                    {githubLinks.map((link, index) => (
                        <a key={`github-${project.slug}-${index}`} href={link} target="_blank">
